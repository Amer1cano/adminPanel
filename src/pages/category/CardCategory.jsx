...
import { useDeleteCategoryMutation } from "../../services/adminApi";
import { toast } from 'react-toastify';
import EditModal from "./EditModal";


const CardCategory = ({item, index,updateBrands}) => {
  ...
  return (
          ...
          <tr className="bg-gray-100 hover:bg-gray-200">
            ...
            <td className="py-3 px-4 border-b border-gray-300">{item?.name_en}</td>
            <td className="py-3 px-4 border-b border-gray-300">{item?.name_ru}</td>
            <td className="py-3 px-4 border-b border-gray-300">
                <img 
                className="w-28 h-24 object-cover"
                src={`https://autoapi.dezinfeksiyatashkent.uz/api/uploads/images/${item?.image_src}`} alt={item?.name_en} />
            </td>
            <td className="py-3 px-4 border-b border-gray-300">
                <div>
                {warning && (
