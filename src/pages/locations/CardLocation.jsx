...
import {  useDeleteLocationMutation } from "../../services/adminApi";
import { toast } from 'react-toastify';
import EditLocation from "./EditLocation";


const CardLocation = ({item,updateBrands}) => {
    ...
    const handleYesDelete = async () => {
        try {
          await deleteLocation(item?.id).unwrap();
            ...
            >
              Yes
                ...
                <div className="">
                    {
                        editModal &&
                        <EditLocation item={item} setEditModal={setEditModal} updateBrands={updateBrands}/>
                    }
                </div>
