...
import { useDeleteCityMutation } from "../../services/adminApi";
import { toast } from 'react-toastify';
import EditCity from "./EditCity";


const CardCity = ({item, index,updateBrands}) => {
            ...
            >
              Yes
                ...
                <div className="">
                    {
                        editModal &&
                        <EditCity item={item} setEditModal={setEditModal} updateBrands={updateBrands}/>
                    }
                </div>
